...
interface IConfigTypes {
 ...
 @doc https://umijs.org/docs/api/config#classpropertiesloose */
    ...
    iconFontCNs?: (Array<string> | undefined);
};
    openApi: {
    requestLibPath?: (string | undefined);
    requestOptionsType?: (string | undefined);
    requestImportStatement?: (string | undefined);
    apiPrefix?: (string | ((args_0: {
    path: string;
    method: string;
    namespace: string;
    functionName: string;
    autoExclude?: (boolean | undefined);
}, ...args: any[]) => string) | undefined);
    serversPath?: (string | undefined);
    schemaPath?: (string | undefined);
    projectName?: (string | undefined);
    namespace?: (string | undefined);
    enumStyle?: ("string-literal" | "enum" | undefined);
    nullable?: (boolean | undefined);
    templatesFolder?: (string | undefined);
    dataFields?: (Array<string> | undefined);
    isCamelCase?: (boolean | undefined);
} | Array<{
    requestLibPath?: (string | undefined);
    requestOptionsType?: (string | undefined);
    requestImportStatement?: (string | undefined);
